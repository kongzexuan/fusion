...
import static com.qn.auto.utils.HttpsAdminUtils.initConfigFile;
import static io.restassured.RestAssured.config;
import static io.restassured.RestAssured.given;
import static org.hamcrest.Matchers.equalTo;

@Slf4j
public class HttpsCompanyUtils {
    public static final String AUTHORIZATION = "Authorization";
    public static final String BEARER = "Bearer ";
    public static final String STRING = "请求响应：";
    ...
    public static Map<String, String> consoleToken(String username, String password) throws IOException {
        ...
        String params= "{\n" +
                ...
                "}";
        Response response = requestSpecification.body(params).log().all().post(URLUtils.getURL("api_name_company_login"));
...
//        LocalCacheUtil.getInstance().putValue(username+"_console_access_token",cookie.toString());
    ...
    private static RequestSpecification getRequestSpecification() throws IOException {
...
//        return httpsUtil(method,urlPath,params,true);
//    }
    /**
     * @param method
     * @param urlPath
    ...
    public static synchronized Response httpsUtil(String method, String urlPath, String params) throws Exception{
        //如果不使用用户名，默认登录
        return httpsUtil(method,urlPath,params,PropertiesUtil.getInstance().getValueByKey("company_username"),PropertiesUtil.getInstance().getValueByKey("company_password"),false);
    }
    public static synchronized Response httpsUtil(String method, String urlPath, String params, File file,String fileName,String fileType) throws Exception {
        //如果不使用用户名，默认登录
        return httpsUtil(method, urlPath, params, PropertiesUtil.getInstance().getValueByKey("company_username"), PropertiesUtil.getInstance().getValueByKey("company_username"), false, file,fileName,fileType);
    }
    /**
     * 控制台使用的http请求方法
     * @param method
